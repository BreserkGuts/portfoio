...
const steps = [
  {
    ...
    description: "We start with a conversation about your project, goals, and vision to understand exactly what you need.",
    code: `// Kickoff call
project: {
  goals: 'your vision',
  audience: 'target viewers',
  style: 'cinematic / bold / clean'
}`,
  },
  {
    number: "02",
    title: "Create",
    subtitle: "& refine",
    description: "I design concepts and share them with you. We collaborate, refine, and iterate until everything feels perfect.",
    code: `// Draft review
await review({
  roughCut: true,
  revisions: 'unlimited',
  ...
  },
  {
    ...
    description: "I deliver the final output and handle revisions if needed. Your video, ready to publish.",
    code: `await export({
  format: '4K ProRes / MP4',
  captions: true,
  revisions: 'included'
})`,
  },
