...
const words = ["retain", "perform", "convert", "captivate"];
    ...
    <section className="relative min-h-screen flex flex-col justify-center items-start overflow-hidden bg-black">
      ...
      <div className="relative z-10 w-full max-w-[1400px] mx-auto px-6 lg:px-12 py-32 lg:py-40">
        ...
        <div className="mb-12">
          ...
          >
            <span className="block whitespace-nowrap">Bold cinematic video,</span>
        ...
        >
          I craft bold, dynamic videos with cinematic color and modern motion design.
          Edits that don&apos;t just look good — they perform.
        </p>
